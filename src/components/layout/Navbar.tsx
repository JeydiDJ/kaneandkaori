    ...
    <header className="sticky top-0 z-50 border-b border-white/55 bg-[rgba(243,237,225,0.88)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-3 py-2 sm:px-4 md:px-6 md:py-3">
        ...
        <nav className="flex items-center gap-1 text-xs text-[var(--muted)] sm:text-sm md:gap-3">
          <Link href={routes.products} className="rounded-full px-2 py-1.5 transition hover:bg-white/65 hover:text-[var(--foreground)] sm:px-3 sm:py-2">
            Shop
          </Link>
          {inStudio ? (
            <>
            ...
            <>
              <Link href={routes.cart} className="inline-flex items-center gap-1 rounded-full px-2 py-1.5 transition hover:bg-white/65 hover:text-[var(--foreground)] sm:gap-2 sm:px-3 sm:py-2">
                Cart
              ...
              <Link href={routes.checkout} className="rounded-full px-2 py-1.5 transition hover:bg-white/65 hover:text-[var(--foreground)] sm:px-3 sm:py-2">
                Checkout
              </Link>
            </>
          )}
